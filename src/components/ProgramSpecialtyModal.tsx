...
const ProgramSpecialtyModal: React.FC<Props> = ({ open, onClose }) => {
    ...
    const handleAddEditSpecialty = () => {
        if (editSpecialtyInput.trim() && !editSpecialties.includes(editSpecialtyInput.trim())) {
    ...
    return (
        <Modal open={open} onClose={onClose}>
            <Box sx={modalStyle}>
                <Typography variant="h5" gutterBottom>Gestión de Programas y Especialidades</Typography>
